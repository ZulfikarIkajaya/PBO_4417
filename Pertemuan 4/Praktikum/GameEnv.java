...
public class GameEnv{
    ...
    private ArrayList<Pemain>arrPlayer =
        new ArrayList<Pemain>();
    private ArrayList<GameMusuh>arrEnemy =
        new ArrayList<GameMusuh>();


    public GameEnv(){
    }
    public void addPlayer(Pemain player){
        arrPlayer.add(player);
    }
    public void removePlayer(Pemain player){
    ...
    public void addEnemy(GameMusuh enemy){
        arrEnemy.add(enemy);
    }

    public void removeEnemy(GameMusuh enemy){
